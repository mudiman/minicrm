            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form name="add-employee-form" id="employee-add" method="POST" enctype="multipart/form-data"
                              action="{{ route('employees.store') }}">
                            @csrf
                            <div class="form-group">
                                <label for="first_name">First name</label>
                                <x-adminlte-input id="first_name" name="first_name" type="text" placeholder="first name"
                                                  value="{{old('first_name')}}" class="@error('first_name') is-invalid @enderror form-control"/>
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <x-adminlte-input id="last_name" name="last_name" type="text" placeholder="last_name name"
                                                  value="{{old('last_name')}}" class="@error('last_name') is-invalid @enderror form-control"/>
                                @error('name')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <x-adminlte-input id="phone" name="phone" type="text" placeholder="phone name"
                                                  value="{{old('phone')}}" class="@error('phone') is-invalid @enderror form-control"/>
                                @error('name')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
